...
### Fixed
- Fixed an issue where subscription options would be displayed for configured products when module is disabled.
- Fixed an issue where payments for subscription orders would not be vaulted if the core Braintree module had vaulting disabled.
